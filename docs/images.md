...
| `v022-d568-fi-aot` (validated, optional) | `FROM v022-d568` | + FlashInfer SM120/SM121 AOT kernel prebake (7 specs, AOT-promoted) | Drop-in replacement for `v022-d568`. Validated dual-node RDMA TP=2 with Qwen3.6-35B-A3B (2026-06-11): no runtime `ninja`/`nvcc`/`cicc`/`ptxas` for the 7 prebaked specs. See [`docs/flashinfer-aot-prebake.md`](flashinfer-aot-prebake.md). |
